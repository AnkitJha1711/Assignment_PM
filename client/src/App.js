  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial" }}>
      ...
      <div style={{ marginBottom: "10px" }}>
        ...
        <button onClick={() => setHeatmapType("kill")} style={btn}>
          Kills
        </button>

        <button onClick={() => setHeatmapType("loot")} style={btn}>
          Loot
        </button>

        <button onClick={() => setHeatmapType("death")} style={btn}>
          Deaths
        </button>

        <button onClick={() => setHeatmapType("none")} style={btn}>
          Clear
        </button>
      </div>
