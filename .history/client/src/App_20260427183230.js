...
function App() {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "Arial" }}>
      ...
      {/* TIMELINE */}
      <div style={{ marginBottom: "20px", background: "#f0f4ff", padding: "15px", borderRadius: "10px" }}>
